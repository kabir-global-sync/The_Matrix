...
def set_matrix_determinant(x):
    ...
    calc_button = Button(root2, text='Calculate', command=lambda: determinant())
...
def matrixOperation(type):
    ...
    row_num = Entry(frm_add, width=10,justify="center")
    ...
    col_num = Entry(frm_add, width=10,justify="center")
    ...
    def matrixSetter(r, c):
        ...
        for j in range(int(r)):
            for i in range(int(c)):
                ...
                e1 = Entry(table1, width=6, justify="center")
                e2 = Entry(table2, width=6, justify="center")
                e1.grid(row=j + 1, column=i + 1, padx=1, pady=1)
                e2.grid(row=j + 1, column=i + 1, padx=1, pady=1)
                p.append(e1)
                q.append(e2)
        ...
        def matrixmanipulation(r, c):
            ...
            for j in range(int(r)):
                for i in range(int(c)):
                    ...
                    e1 = Entry(result_frm, width=6,justify="center")
                    e1.grid(row=j + 1, column=i + 1, padx=1, pady=1)
...
def matrix_multiplication():
    ...
    row_num1 = Entry(matrix1_frm, width=10,justify="center")
    ...
    col_num1 = Entry(matrix1_frm, width=10,justify="center")
    ...
    row_num2 = Entry(matrix2_frm, width=10,justify="center")
    ...
    col_num2 = Entry(matrix2_frm, width=10,justify="center")
    ...
    def set_multiply_matrix(r1, c1, r2, c2):
        ...
        for j in range(int(r2)):
            for i in range(int(c2)):
                Label(table2, text=f"C{i + 1}").grid(row=0, column=i + 1)
                e1 = Entry(table2, width=6,justify="center")
                e1.grid(row=j + 1, column=i + 1, padx=1, pady=1)
                q.append(e1)
            Label(table2, text=f"R{j + 1}").grid(row=j + 1, column=0)
            matrix2.append(q)
